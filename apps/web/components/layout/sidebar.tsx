          ...
          <div key={section.label}>
            ...
            <div className="pb-1 pt-3 first:pt-1">
              <button
                ...
                className="mb-[2px] flex w-full items-center gap-[6px] px-5 text-[14px] font-medium uppercase tracking-[0.12em] text-[rgba(158,174,172,0.6)] transition-colors hover:text-[rgba(158,174,172,0.9)]"
