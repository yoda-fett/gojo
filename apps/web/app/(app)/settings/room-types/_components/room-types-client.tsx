...
export function RoomTypesClient({ initial }: { initial: RoomType[] }) {
  ...
  // The add / edit form. Rendered above the table when adding a new room type,
  // and inline directly below the row being edited.
    ...
    >
      <div style={cardStyle}>
        <div style={cardHeader}>
          ...
          {!form ? (
            <button type="button" style={btn('primary', busy)} disabled={busy} onClick={startNew}>
              + Add room type
            </button>
          ) : null}
        </div>
